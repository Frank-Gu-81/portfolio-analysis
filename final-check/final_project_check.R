...
setwd("/Users/frank/Documents/Northwestern\ Senior/Winter\ Quarter/STAT\ 365/STAT365_Code/Final\ Project")
...
p_eqw_params <- cbind(beta_p_eqw, alpha_p_eqw, mr_p_eqw, nmr_p_eqw) |> 
  as.data.frame() |> 
  rename("Beta" = "beta_p_eqw", "Alpha" = "alpha_p_eqw", "Market Risk" = "mr_p_eqw", "Non-Market Risk" = "nmr_p_eqw")
